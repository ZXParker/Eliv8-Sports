...
const features = [
  {
    ...
    description: "Advanced AI analysis of shooting technique, power, accuracy, and release mechanics.",
    gradient: "from-green-500/20 via-green-500/10 to-green-500/5"
  },
  {
    icon: Target,
    title: "Stick Skills",
    description: "Comprehensive tracking of stick handling, dodging techniques, and ball control precision.",
    gradient: "from-lime-500/20 via-lime-500/10 to-lime-500/5"
  },
  {
    icon: BarChart3,
    title: "Performance Metrics",
    description: "Detailed analytics including speed, agility, field awareness, and game-specific performance indicators.",
...
export default function LacrosseAbout() {
  return (
          ...
          >
            <motion.div variants={item}>
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight text-white mb-6">
                Master Your Lacrosse Performance
              </h1>
              <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto">
                Advanced analytics and AI-powered training to elevate every aspect of your lacrosse game.
              </p>
            </motion.div>
          </motion.div>
        </div>
        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-white">
              Elevate Your Lacrosse Skills
            </h2>
            <p className="text-lg text-gray-300">
              Join lacrosse players who are already using our platform to transform their game.
            </p>
            <Button 
  size="lg" 
