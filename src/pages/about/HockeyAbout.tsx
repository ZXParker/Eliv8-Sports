...
const features = [
  {
    ...
    description: "Advanced AI analysis of skating technique, stride mechanics, and edge control with precision feedback.",
    gradient: "from-blue-500/20 via-blue-500/10 to-blue-500/5"
  },
  {
    icon: Target,
    title: "Shot Performance",
    description: "Comprehensive tracking of shot power, accuracy, release speed, and puck trajectory.",
    gradient: "from-cyan-500/20 via-cyan-500/10 to-cyan-500/5"
  },
  {
    icon: BarChart3,
    title: "Performance Metrics",
    description: "Detailed analytics including speed, endurance, agility, and game-specific performance indicators.",
...
export default function HockeyAbout() {
  return (
          ...
          >
            <motion.div variants={item}>
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight text-white mb-6">
                Master Your Hockey Performance
              </h1>
              <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto">
                Advanced analytics and AI-powered training to elevate every aspect of your hockey game.
              </p>
            </motion.div>
          </motion.div>
        </div>
        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-white">
              Elevate Your Hockey Skills
            </h2>
            <p className="text-lg text-gray-300">
              Join hockey players who are already using our platform to transform their game.
            </p>
            <Button 
  size="lg" 
