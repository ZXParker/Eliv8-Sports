...
const navigation: NavigationItem[] = [
  { 
    ...
    path: '/athlete', 
    icon: Trophy,
    description: 'View your sports activities'
  },
  { 
    name: 'Access Code', 
    path: '/athlete/access-code', 
    icon: KeyRound,
    description: 'Join a team with code'
  },
  { 
    name: 'Subscription', 
    ...
    const loadUserProfile = async () => {
      try {
        ...
        if (profile?.first_name) {
          setWelcomeMessage(`Welcome back, ${profile.first_name}!`);
        }
      } catch (error) {
        ...
        >
          <SheetHeader>
            <div className="flex items-center space-x-3 p-4">
              ...
              <SheetTitle className="text-white">Athlete Portal</SheetTitle>
            </div>
          </SheetHeader>
      ...
      <div className="hidden lg:fixed lg:inset-y-0 lg:flex lg:flex-col">
        <div className="flex flex-col flex-grow w-64 bg-gray-900/95 backdrop-blur-xl border-r border-white/10 pt-5">
          <div className="flex items-center space-x-3 px-6 mb-8">
            ...
            <div>
              <h1 className="text-lg font-bold text-white">Athlete Portal</h1>
            </div>
          </div>
