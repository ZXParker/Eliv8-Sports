...
export default function CoachSubscriptionManagement() {
  ...
  useRealtimeSubscription('coach_subscriptions', (payload) => {
    if (payload.eventType === 'UPDATE' && payload.new.id === subscription?.id) {
      setSubscription(payload.new);
    }
  });

  useRealtimeSubscription('coach_billing_history', () => {
    fetchBillingHistory();
  });
    ...
    try {
      ...
      setSubscription({
        ...
        features: [
          ...
          'Messaging system with athletes'
        ]
      });
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
          <div className="space-y-2">
            ...
            <p className="text-gray-400">
              Manage your coaching subscription, payments, and billing details
            </p>
          </div>
        </div>
      </motion.div>
                ...
                <div className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="p-4 rounded-lg bg-blue-500/5 border border-blue-500/20">
                      <p className="text-sm text-gray-400 mb-1">Coaching Plan</p>
                  ...
                  {/* Plan Features */}
                  <div className="p-4 rounded-lg bg-blue-500/5 border border-blue-500/20">
                    <h3 className="text-white font-medium mb-4">Plan Features</h3>
